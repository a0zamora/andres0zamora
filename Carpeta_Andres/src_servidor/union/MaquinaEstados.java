 ...
 * 
 */
public class MaquinaEstados extends Card {
	...
	// *****************************CONSTRUCTOR*****************************//
	public MaquinaEstados(Partida partida) {
	...
	protected void eventoInternoDisparado(TipoDeEvento evento,
			...
			throws UnknowEventForState, IdCreadorInvalido {
		if (disparado) {
	...
	private void estadoEliendoCartas(TipoDeEvento evento,
		...
		case creadorRdy:
			if (id == this.idCreador) {
				...
				throw new IdCreadorInvalido(id);
			}
			break;
	...
	private void estadoValidarJugada_A(TipoDeEvento evento,
			Map<String, Object> ctx, Map<String, Object> par, int id)
			throws IdCreadorInvalido, UnknowEventForState {
