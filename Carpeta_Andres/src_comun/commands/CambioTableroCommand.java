...
public class CambioTableroCommand implements Command{

	public static final String CADENA_COMANDO = "Cambio_tablero";
...
public CambioTableroCommand(String str) {
	...
	public CambioTableroCommand( Elemento elemento ,TipoColor color, boolean ramdon ) {
	 ...
	 * 			vale false si es el cambio o cambios de tablero por una linea o diagonal
	 */	
public CambioTableroCommand( Elemento elemento ,boolean ramdon ) {
