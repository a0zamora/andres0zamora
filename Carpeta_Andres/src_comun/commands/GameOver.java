...
public class GameOver implements Command {
	...
	public static final String CADENA_COMANDO = "gameOver";
	...
	public GameOver( int idGanador , int ptsGanador, int ptsPerdedor) {
...
public GameOver( int ptsEmpate, int ptsEmpate1) {
